...
################################################################################################
### sbatch configuration parameters (GPU — Qwen3-VL-8B-Thinking HF smoke test)
### 1×RTX 4090 (24 GB), multits env
################################################################################################

#SBATCH --partition main
#SBATCH --time 0-00:20:00
#SBATCH --job-name qwenvl8b_thinking_smoke
#SBATCH --output logs_terminal/qwenvl8b_thinking_smoke_%J.out
...
python run_icl.py \
  ...
  --method Qwen/Qwen3-VL-8B-Thinking \
  --num_shots 1 \
